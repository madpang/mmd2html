...
Here we define node classes such as Document, **MetaMatter**, **Section**, and various block types (Paragraph, List, CodeBlock, QuoteBlock, etc.). The Document node holds a MetaMatter and a list of Section nodes.
